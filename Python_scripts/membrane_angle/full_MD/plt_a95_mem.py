...
ax1.set_title('Bir')
ax1.set_xlabel('Protein angle of insertion / º')
ax2.hist(data_17L, bins=400)
ax2.set_title('17L')
ax2.set_xlabel('Protein angle of insertion / º')
ax3.hist(data_4G, bins=400)
ax3.set_xlabel('Protein angle of insertion / º')
ax3.set_title('4G')
ax4.hist(data_10, bins=400)
ax4.set_title('10')
ax4.set_xlabel('Protein angle of insertion / º')
plt.tight_layout()
